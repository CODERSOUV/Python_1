    ...
    for i in range(4):
        for j in range(4):
            ...
            if text == '=':
                ...
                Button(root, text=text, command=lambda t=text: press(t), background="black", fg="white", height=button_height, width=button_width).grid(row=i + 1, column=j, padx=padx_value, pady=pady_value)
